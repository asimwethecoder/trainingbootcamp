...
const AboutPage = () => {
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="bg-gray-50 mt-8">
        <div className="mx-auto max-w-7xl px-4 py-12">
          <div className="flex flex-col items-center space-y-4 text-center">
            <h2 className="text-6xl font-bold text-gray-900">About Us</h2>
            <nav className="flex font-bold space-x-2 text-gray-600">
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="space-y-6 text-lg lg:text-xl text-gray-600">
                <p>
                ...
                <Link
                  href="/contact"
                  className="inline-block px-8 py-3 bg-black text-white rounded-full border-2 border-black hover:bg-transparent hover:text-black transition-all duration-300"
                >
                  Connect with us
                </Link>
              </div>
      ...
      {/* Core Values Section */}
      <section className="bg-black text-white py-20 px-4 lg:py-24 mx-4 rounded-3xl">
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-gray-50 p-8 rounded-2xl">
              <h2 className="text-6xl font-bold mb-6">Our Vision</h2>
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="text-8xl font-bold mb-12 text-center">What We Offer</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold mb-4">Comprehensive Programs</h3>
              <p className="text-gray-600">From AWS certifications to coding and data science, we offer training programs for every career stage.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold mb-4">Collaborative Hackathons</h3>
              <p className="text-gray-600">Build portfolios, explore AWS services, and collaborate with peers in dynamic, real-world scenarios.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold mb-4">Global Accessibility</h3>
              <p className="text-gray-600">Free, online programs accessible globally to anyone with an internet connection.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold mb-4">Proven Track Record</h3>
              <p className="text-gray-600">90% program completion rate and 50% AWS certification success rate within 60 days.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="text-6xl font-bold mb-12 text-center">Why Choose SmartFocus?</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-8 rounded-2xl">
              <h3 className="text-xl font-bold mb-4">Our Approach to Learning</h3>
